...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const activeNavObserverOptions = {
        threshold: 0.02, // 2% visibility (extremely responsive threshold guarantees tall sections like #board trigger perfectly)
        rootMargin: '-10% 0px -60% 0px' // Active scroll zone in upper half of screen (de-activates previous items instantly on entering)
    };
